...
= 1.1.7 =
* Fixed: the bundled Spanish VAT number pattern accepted numbers that start and end with a digit, which Spain never issues; such a number is now rejected by the offline format check instead of being sent to VIES
